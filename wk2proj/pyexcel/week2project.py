...
## records uses vlist dict for colums
#
## Runtime
...
#
while(True):
    vlistdict.append(ventry()) # add an item to the list returned by ventry() {"site": value, "hostname": value, "location": value, "IP": value, "subnet": value, "vlan": value}
